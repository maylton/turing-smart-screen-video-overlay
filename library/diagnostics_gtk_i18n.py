...
_PT_BR = {
    ...
    "GPU sensors": "Sensores da GPU",
    "Configure GPU": "Configurar GPU",
    "Automatic selection": "Seleção automática",
    "Index {index}": "Índice {index}",
    "No AMD GPU detected": "Nenhuma GPU AMD detectada",
    "Load {load}% · {temperature} °C": "Carga {load}% · {temperature} °C",
    "GPU selector was not found": "O seletor de GPU não foi encontrado",
    "Could not open GPU selector: {error}": "Não foi possível abrir o seletor de GPU: {error}",
    "Theme": "Tema",
    "Video": "Vídeo",
    "Runtime": "Execução",
    "Serial": "Serial",
