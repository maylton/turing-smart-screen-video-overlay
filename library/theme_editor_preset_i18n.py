...
_PT_BR = {
    ...
    "Graph bar preset": "Preset de barra do gráfico",
    "Image component preset": "Preset de imagem",
    "Line graph preset": "Preset de gráfico de linha",
    "Component preset": "Preset do componente",
    ...
    "Apply a starter layout to this component": "Aplica um layout inicial a este componente",
    ...
    "Hero ring": "Anel em destaque",
    "Arc gauge": "Medidor em arco",
    "Compact ring": "Anel compacto",
    "Minimal sparkline": "Linha minimalista",
    "Axis trend graph": "Gráfico de tendência com eixos",
    "Thin compact trend": "Tendência fina compacta",
    ...
    "AXIS_FONT": "Fonte dos eixos",
    "CUSTOM_BBOX": "Caixa personalizada",
    "TEXT_OFFSET": "Deslocamento do texto",
    "BAR_DECORATION": "Decoração da barra",
    "ALIGN": "Alinhamento",
    "ANCHOR": "Âncora",
    ...
    "Choose an axis label font from res/fonts.": "Escolha uma fonte de rótulos dos eixos em res/fonts.",
    "Choose an image from this theme folder.": "Escolha uma imagem da pasta do tema.",
    "Choose a preview image from this theme folder.": "Escolha uma imagem de prévia da pasta do tema.",
    "Choose a video from the theme folder or display storage.": "Escolha um vídeo da pasta do tema ou do armazenamento da tela.",
    ...
    "Choose the date/time format style.": "Escolha o estilo de formato de data/hora.",
    "Choose the radial bar decoration style.": "Escolha o estilo de decoração da barra radial.",
    "Choose how this GRAPH bar fills.": "Escolha como esta barra de gráfico é preenchida.",
    "Choose a value for {key}.": "Escolha um valor para {key}.",
    "Choose a common value, or type a custom value in the field.": "Escolha um valor comum ou digite um valor personalizado no campo.",
    "Disabled": "Desativado",
    "Current": "Atual",
    "Auto": "Automático",
